package com.example.nodoandroidroompractice;

import android.content.Intent;
import android.os.Bundle;

import com.example.nodoandroidroompractice.model.NoDo;
import com.example.nodoandroidroompractice.model.NoDoViewModel;
import com.example.nodoandroidroompractice.ui.NoDoListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noDoViewModel.getAllNoDos().observe(this, new Observer<List<NoDo>>() {
            ...
            public void onChanged(List<NoDo> noDos) {
                //update the saved/cached copy of our noDos in the Adapter.
